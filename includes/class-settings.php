...
class PS_Settings
{
    ...
    private function __construct()
    {
        ...
        add_action('wp_ajax_ps_flush_permalinks', array($this, 'ajax_flush_permalinks'));
    }
            ...
            <form method="post" action="options.php" id="ps-settings-form">
                ...
                <div class="ps-tab-content" id="ps-tab-banner" style="display:none;">
                            ...
                            <div class="ps-form-group">
                                <div class="ps-image-upload">
                                    ...
                                    <div class="ps-actions">
                                        <button type="button" class="ps-btn ps-btn-secondary" id="ps_banner_image_btn">
                                            <?php _e('Select Image', 'pocket-showroom'); ?>
                                        </button>
                                        <button type="button" class="ps-btn ps-btn-secondary" id="ps_remove_banner_image"
                                            style="<?php echo $banner_image_id ? '' : 'display:none;'; ?> color: #d63638; border-color: #d63638;">
                    ...
                    <div class="ps-banner-preview-row">
                        <h3>
                            <?php _e('Live Preview', 'pocket-showroom'); ?>
                        </h3>
                            ...
                            <div id="ps-live-preview-container"
                                ...
                                <div style="position:relative; z-index:2; padding:20px;">
                                    ...
                                    <div style="margin-top: 0;">
                                        <span class="ps-preview-btn" id="ps-preview-banner-btn"
                                            style="display:inline-block; padding: 10px 24px; background-color: <?php echo esc_attr($primary_color); ?>; color:<?php echo esc_attr($button_text_color); ?>; border-radius:4px; font-size:14px; font-weight:600;">
                                ...
                                <div
                                    ...
                                    <span style="font-size:10px; text-transform:uppercase; letter-spacing:1px;">
                                        <?php _e('Products Ready', 'pocket-showroom'); ?>
                                    </span>
                                </div>
                            </div>
                        </div>
