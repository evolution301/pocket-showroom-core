...
$zipPath = Join-Path $parentDir "pocket-showroom-core.zip"
powershell -Command "Compress-Archive -Path '$PWD\*' -DestinationPath '$zipPath' -Force"
...
Write-Host "https://github.com/evolution301/pocket-showroom-core/releases/download/$Version/pocket-showroom-core.zip" -ForegroundColor Cyan
Write-Host ""
